...
Java_com_ywl5320_myplayer_player_WlPlayer_n_1duration(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_ywl5320_myplayer_player_WlPlayer_n_1volume(JNIEnv *env, jobject instance, jint percent) {
...
JNIEXPORT jint JNICALL
Java_com_ywl5320_myplayer_player_WlPlayer_n_1samplerate(JNIEnv *env, jobject instance) {
